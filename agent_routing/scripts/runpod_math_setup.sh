...
MARGENT_WANDB_MODE=disabled "$MARGENT_VENV/bin/python" -m pytest -q tests/test_verifiable.py tests/test_math_reporting.py tests/test_math_wandb.py tests/test_math_wandb_tables.py tests/test_math_advisor_sampling.py tests/test_math_advisor_replay.py tests/test_math_paper_protocol.py tests/test_marginal_value.py tests/test_benchmark_loaders.py tests/test_routing_anchor.py
