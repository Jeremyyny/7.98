...
"$MARGENT_VENV/bin/python" -m pytest -q tests/test_verifiable.py tests/test_math_reporting.py tests/test_marginal_value.py tests/test_benchmark_loaders.py tests/test_routing_anchor.py
